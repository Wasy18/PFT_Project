...
class Report_Type(ttk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.whole = ttk.Radiobutton(self, text="Whole Set Report", variable=self.v, value=3)
        self.top_set = ttk.Radiobutton(self, text="Top Set Report", variable=self.v, value=4)
